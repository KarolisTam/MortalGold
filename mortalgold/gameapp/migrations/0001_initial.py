    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player1_character', models.PositiveSmallIntegerField(blank=True, choices=[(0, 'Putin'), (1, 'Musk')], null=True, verbose_name='Player 1 Character')),
                ('player2_character', models.PositiveSmallIntegerField(blank=True, choices=[(0, 'Putin'), (1, 'Musk')], null=True, verbose_name='Player 2 Character')),
